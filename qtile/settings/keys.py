# Ignacio Toledo
# https://github.com/IgnacioToledoDev/dotfiles
...
keys = [Key(key[0], key[1], *key[2:]) for key in [
    ...
    # Reload config (restart no funciona en Wayland)
    ...
    # Power menu
    ([mod], "x", lazy.spawn("bash /home/ignacio/.config/qtile/scripts/power_menu.sh")),
